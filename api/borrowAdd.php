<?php
   ...
   //3. 构造sql语句
   @$sqlStr="insert into borrowInfo(borrowType,borrowAmount,currentRate,monthes2Return,repayment,minAmount,rewardAmount,disableDays,borrowTitle,description,userid) values('$borrowType','$borrowAmount','$currentRate','$monthes2Return','$repayment','$minAmount','$rewardAmount','$disableDays','$borrowTitle','$description','$userid')";
